  ...
  },
  {
    ...
    i18n: {
      ...
      'zh-TW': {
        slug: 'pdf-壓縮',
        title: 'PDF 壓縮',
        shortDesc: '線上縮小 PDF 檔案大小，不傷畫質',
        description: '線上免費 PDF 壓縮工具。完全在地處理，公文與隱私文件免上傳，安全無虞。',
        metaTitle: 'PDF 壓縮線上免費版 - 免上傳、100% 隱私保護、快速縮小 PDF KB 數',
        metaDescription: '最強隱私 PDF 壓縮工具。所有處理都在您的瀏覽器端執行，檔案無需上傳至伺服器，確保合約與私人文件 100% 安全不外洩。',
        keywords: ['pdf 壓縮', '縮小 pdf', 'pdf 檔案壓縮', 'pdf 瘦身', '在地處理', 'pdf 免上傳']
      }
    }
  },
